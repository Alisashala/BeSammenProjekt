...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        // Først hentes den aktuelle bruger fra Firebase Authentication ved hjælp af
        // mAuth.getCurrentUser() metoden.
    ...
    // Metode kaldt når aktiviteten oprettes
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Identificerer 'view'-komponenterne i layoutfilen ved hjælp af deres unikke id'er
        // og tilordner dem til de tilsvarende variabler.
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            // Når brugeren klikker på dette View, oprettes intent  for at navigere fra SignUpActivity
            // til LoginActivity
            public void onClick(View v) {
                Intent intentToLogin = new Intent(getApplicationContext(), LoginActivity.class);

                // Starter LoginActivity og afslutter den nuværende aktivitet.
                startActivity(intentToLogin);
                finish();
            }
        });

        // Angiver en onClick-listener til signUpBtn.
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Opretter en ny brugerkonto i Firebase Authentication ved hjælp af den angivne
                // email og adgangskode.
                mAuth.createUserWithEmailAndPassword(email, password)

                        // Tilføjer en onCompleteListener til at lytte efter afslutningen af
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                // Hvis oprettelsen er succesfuld, vises en kort besked om,
                                // at kontoen er oprettet.
                                if (task.isSuccessful()) {
                                    ...
                                    // Opretter en Intent til at navigere fra SignupActivity
                                    // til MainActivity.
                                    Intent intentToMain = new Intent(SignUpActivity.this, MainActivity.class);

                                    // Sender brugernavnet som en ekstra information med Intent.
                                    //key = nøgle
                                    //message = værdien
                                    intentToMain.putExtra("key", message);

                                    // Starter MainActivity med Intenten.
                                    startActivity(intentToMain);

                                } else {
                                    // Hvis oprettelsen fejler, vises en kort besked om, at
